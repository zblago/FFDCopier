...
///
/// Core part of FFDCopier.
//	Consist of methods for creating the destination folder, copy files and folders.
//	Rollback is also implemented. If something goes wrong rollback deletes previously created files and folders.
///
class DirCopier
{
	private:
	...
	public:	
		...
		char* CreateDestinationFolder(char *pDest){ 
		...
		int CopyDirsAndFiles(char* sourceDir, char* destDir = nullptr){
